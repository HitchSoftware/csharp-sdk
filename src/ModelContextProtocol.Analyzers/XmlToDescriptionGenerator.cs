...
{
    private const string GeneratedFileName = "Garden.ModelContextProtocol.Descriptions.g.cs";
    ...
    private static string GenerateSourceFile(EquatableArray<MethodToGenerate> methods)
    {
        ...
        writer.WriteLine($"// Garden.ModelContextProtocol.Analyzers {typeof(XmlToDescriptionGenerator).Assembly.GetName().Version}");
        writer.WriteLine();
        writer.WriteLine("#pragma warning disable");
        writer.WriteLine();
        writer.WriteLine("using System.ComponentModel;");
        writer.WriteLine("using Garden.ModelContextProtocol.Server;");
        writer.WriteLine();
